  ...
  <div>
    <v-layout class="v-card white" row wrap>
      <v-flex :class="{[$store.state.colorTheme] : true}" xs12>
        <div class="display-1 px-3 py-4 bold white--text">
          {{ $store.state.mallData.name }}
        </div>
      </v-flex>
      <v-flex class="white px-3 pt-3 pb-5" xs8>
      ...
      <v-flex class="grey lighten-4 secondary--text" xs4>
        <div class="title bold px-3 pt-3">
          <div :class="{[colorTheme] : true}">
        ...
        <div v-if="$store.state.mallData.skills.length > 0">
          <div class="title bold px-3 pt-2 pb-1">
            <div :class="{[colorTheme] : true}">
          ...
          <div class="pb-5 pt-2">
            <div :key="x.id" v-for="x in $store.state.mallData.languages" class="py-1 px-3">
              ...
              <div style="position:relative">
                ...
                <div style="position:absolute;right:0;top:12px" class="secondary--text">
                  {{ level(x.niva) }}
                </div>
              </div>
            </div>
